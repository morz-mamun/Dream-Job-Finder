...
const BidRequest = () => {
  ...
  useEffect(() => {
    axios
      .get(` https://dream-job-finder-server-ahb4czqop-mamuns-projects.vercel.app/bidprojects/${user?.email}`)
      .then((res) => {
  ...
  const handleAccept = (id) => {
    fetch(` https://dream-job-finder-server-ahb4czqop-mamuns-projects.vercel.app/bidprojects/${user?.email}/${id}`, {
        method: "PATCH",
        headers: {
